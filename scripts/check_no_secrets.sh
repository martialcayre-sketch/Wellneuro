...
# SHEET_ID en dur probable : long identifiant Google Sheets après une mention SHEET_ID.
...
# Emails : autoriser uniquement l'adresse de développement explicitement prévue.
